...
| hanuman-chalisa-opening | **bengali** | hanumanchalisainbengali.co.in (+ search corroboration) | match | Native Bengali Chalisa **uses candrabindu (ঁ)** — বরনউঁ, তিহুঁ, কাঁধে, মূঁজ — matching our output (মোহিং carries anusvara, faithful to the master's मोहिं). Search corroborates কাঁধে মূঁজ জনেউ and যো দায়কু. (Bengali expresses 6 of the 8 master-anusvaras as homorganic nasal conjuncts — ঞ্জ/ঙ্গ/ঞ্চ — standard Bengali orthography; verified mechanically.) |
